...
public class likeTest {
    ...
    public void likePostTest() {
        ...
        Assertions.assertEquals(1, postResponse.like());
    }

    @Test
    public void likeReplyTest() {
        ReplyResponse replyResponse = replyService.likeReply(replyId);
        Assertions.assertEquals(1, replyResponse.like());
    }
}
